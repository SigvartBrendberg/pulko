...
pulko.o : pulko.cpp propellantLibrary.hpp parts.hpp engines.hpp state.hpp orbit.hpp spacecraft.hpp parts.hpp propellants.hpp compounds.hpp
	g++ -O3 -c pulko.cpp
orbit.o : orbit.cpp
	g++ -O3 -c orbit.cpp
...
descent.o : descent.cpp spacecraft.hpp parts.hpp propellants.hpp compounds.hpp
	g++ -O3 -c descent.cpp
